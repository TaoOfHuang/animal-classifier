...
exports.getTaxonomyTree = void 0;
const externalApiService_1 = require("./externalApiService");
const getFallbackTree = (level, name) => ({
    current: {
        level,
        scientificName: name,
...
exports.getTaxonomyTree = getTaxonomyTree;
